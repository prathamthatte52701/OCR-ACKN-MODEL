...
export default function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#020817] text-slate-100">
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-blue-400/10 bg-slate-950/72 shadow-[0_14px_40px_rgba(2,8,23,0.28)] backdrop-blur-xl">
